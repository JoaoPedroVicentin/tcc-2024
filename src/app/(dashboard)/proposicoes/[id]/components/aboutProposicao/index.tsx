        ...
        <div className="flex flex-wrap gap-8">
            ...
            <Title
              ...
              info={
                <p className="text-sm text-black">
                  Informações gerais sobre a proposição específica, como seu
                  tipo, situação atual, temas abordados, autores, e logo acima,
                  um botão que redireciona para o documento oficial completo da
                  proposição.
                </p>
              }
            />
          ...
          {autores && autores.data.dados.length > 0 && (
            <div className="flex flex-col gap-5">
              ...
              <div className="flex h-72 flex-col gap-5 overflow-x-hidden overflow-y-scroll pr-4">
