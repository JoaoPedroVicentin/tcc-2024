export const SITUACOES_PROPOSICAO = [
  ...
  {
    cod: '1180',
    nome: 'Aguardando Apoiamento - Conferência de Assinaturas',
  },
  {
    cod: '1185',
    nome: 'Aguardando Apoiamento - Coleta de Assinaturas',
  },
  {
    cod: '1200',
  ...
  {
    cod: '1201',
    nome: 'Aguardando Despacho do Presidente da Câmara dos Deputados (Chancela)',
  },
  {
    cod: '1210',
    nome: 'Aguardando Chancela e Publicação do Despacho',
  },
  {
    cod: '1220',
    nome: 'Aguardando Despacho do Presidente da Câmara dos Deputados (Análise)',
  },
  {
    cod: '1221',
    nome: 'Aguardando Despacho do Presidente da Câmara dos Deputados (Autorização)',
  },
  {
    cod: '1222',
    nome: 'Prejudicialidade',
  },
  {
    cod: '1230',
  ...
  {
    cod: '1295',
    nome: 'Aguardando Reformulação de Parecer',
  },
  {
    cod: '1296',
  ...
  {
    cod: '1312',
    nome: 'Aguardando Instauração do Processo',
  },
  {
    cod: '1313',
    nome: 'Aguardando Parecer Preliminar no Conselho de Ética',
  },
  {
    cod: '1314',
    nome: 'Aguardando Defesa Escrita no Conselho de Ética',
  },
  {
    cod: '1350',
    nome: 'Aguardando Notificação do Representado',
  },
  {
    cod: '1355',
    nome: 'Em Instrução Probatória',
  },
  {
    cod: '1360',
    nome: 'Tramitação Suspensa',
  },
  {
    cod: '1380',
    nome: 'Aguardando Elaboração do Parecer pelo Relator',
  },
]
